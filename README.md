...
3. می‌توانید دسته‌بندی جدید اضافه یا حذف کنید
...
### اجرای تست با خروجی تفصیلی

```bash
flutter test --reporter expanded
```

### اجرای تست با پوشش کد
...
توسعه‌دهندگان این پروژه

## 📞 تماس و پشتیبانی

برای سوالات و پشتیبانی، لطفاً یک Issue در مخزن GitHub ایجاد کنید.
